                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('update-color') }}" method="POST">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="name" value="{{ $color->name }}" class="form-control" id="horizontal-firstname-input" />
                        ...
                        <div class="form-group row justify-content-end">
                            <div class="col-sm-9">
                                <div>
                                    <button type="submit" class="btn btn-primary w-md">Update New Color</button>
                                </div>
                            </div>
                        </div>
                    </form>
