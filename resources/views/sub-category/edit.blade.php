                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('update-sub-category') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" value="{{ $sub_category->name }}" name="name" class="form-control" id="horizontal-firstname-input">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                ...
                                <img src="{{ asset($sub_category->image) }}" alt="" height="100" width="140" class="mt-2">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" {{ $sub_category->status == 1 ? 'checked' : ' ' }} type="radio" name="status" id="inlineRadio1" value="1">
                                    <label class="form-check-label" for="inlineRadio1">Published</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" {{ $sub_category->status == 0 ? 'checked' : ' ' }}type="radio" name="status" id="inlineRadio2" value="0">
